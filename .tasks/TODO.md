...
- [x] 03: Answer and deliver — [details](03-answer-and-deliver.md)
- [x] 04: `askance ask` CLI — [details](04-askance-ask-cli.md)
- [x] 05: End-to-end example + quickstart — [details](05-example-and-quickstart.md)
