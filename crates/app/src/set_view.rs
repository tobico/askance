...
fn question(question: QuestionView, fields: &mut Vec<Asked>) -> impl IntoView + use<> {
...
fn settled_question(question: &QuestionView, response: Option<&Response>) -> impl IntoView + use<> {
